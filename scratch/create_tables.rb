module GCSAdvantage
	# manufacture_parts` (`mfr`, `mpn`, `name`, `href_name`, `desc`, `low_price`, `sources
	...
	DB.create_table?(:products) do
		...
		foreign_key :manufactures_id, :manufactures, :null=>false
		...
		index [:name, :manufactures_id], :unique=>true
	end

...
G.prototype.A=function(){if(this.f)for(;this.f.length;)this.f.shift()()};function Da(a,b){var c=Ea;Object.prototype.hasOwnProperty.call(c,a)||(c[a]=b(a))}
    var Fa = A("Opera"), H = A("Trident") || A("MSIE"), Ga = A("Edge"),
...
function Ua(a,b){for(var c=0;a;){if(b(a))return a;a=a.parentNode;c++}return null}
    var J = "StopIteration" in k ? k.StopIteration : {message: "StopIteration", stack: ""};
    function K() {
    }
...
return b}
    var Ya = k.JSON.parse, Za = k.JSON.stringify;
    function L(a) {
        G.call(this);
        this.m = 1;
        this.g = [];
...
var jb=/#|$/;var O=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};u("yt.config_",O);function kb(a){var b=arguments;if(1<b.length)O[b[0]]=b[1];else{var b=b[0],c;for(c in b)O[c]=b[c]}}
    ...
    var nb = 0, ob = m("ytDomDomGetNextId") || function () {
            return ++nb
        };
...
function Bb(a,b){M.I.apply(M,arguments)}
    function S(a, b, c) {
        ...
        this.v = {};
        b = document;
        if (a = q(a) ? b.getElementById(a) : a)if ("iframe" != a.tagName.toLowerCase() && (b = Cb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[r] || (b[r] = ++ca), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
            this.f = new L;
            Db(this);
            a = T(this.b, "events");
